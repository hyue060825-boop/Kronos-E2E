...
class Config:
    ...
    def __init__(self):
        ...
        self.dataset_begin_time = "1999-11-10"
        self.dataset_end_time = '2020-09-25'
        ...
        self.val_time_range = ["2018-09-01", "2019-12-31"]
        self.test_time_range = ["2019-09-01", "2020-09-25"]
        self.backtest_time_range = ["2020-01-14", "2020-09-11"]
